...
class MeetVideo extends Component {
	constructor(props) {
		super(props)
...
render() {
  if (this.isChrome() === false) {
    return (
      <div className="bg-white w-30 h-auto p-20 min-w-400 text-center mx-auto mt-50 justify-center">
  ...
  return (
    <div>
      {this.state.askForUsername === true ? (
        <div>
          <div className="bg-white w-30 h-auto p-20 min-w-400 text-center mx-auto mt-50 justify-center">
            <p className="font-bold" style={{ paddingRight: "50px" }}>
              Set your username
            </p>
            <input
            ...
            />
            <button
              className="bg-blue-500 text-white px-4 py-2 rounded mt-20"
          ...
          <div className="justify-center text-center pt-40">
            <video
              ...
              autoPlay
              muted
              className="border-solid border border-gray-400 object-fill w-60 h-30"
            ></video>
          </div>
        </div>
      ) : (
        <div>
          <div className="btn-down bg-whitesmoke text-whitesmoke text-center">
          ...
          <Modal show={this.state.showModal} onHide={this.closeChat} style={{ zIndex: "999999" }}>
            ...
            <Modal.Body
              style={{ overflow: "auto", overflowY: "auto", height: "400px", textAlign: "left" }}
            >
          ...
          <div className="container">
            <div style={{ paddingTop: "20px" }}>
              <input value={window.location.href} disabled="true" className="border p-2" />
              <button
                className="bg-blue-500 text-white px-4 py-2 rounded ml-20 mt-10 w-120 text-xs"
            ...
            <Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
              <video
                ...
                autoPlay
                muted
                className="border-solid border border-gray-400 m-10 object-fill w-100 h-100"
              ></video>
            </Row>
          </div>
        </div>
